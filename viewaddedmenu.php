...
$con = mysqli_connect("localhost", "root", "");
	...
	$sql = "select bookingdetail.mid,menuname,fdate,fdesc,rate,quantity from menu,bookingdetail where menu.mid=bookingdetail.mid and bookingid=$q";
	...
	echo"<tr><th>Function Date</th><th>Function Description</th><th>Service</th><th>Rate</th><th>Quantity</th><th>Amount</th></tr>";
	$total=0;	
	while($rowval = mysqli_fetch_array($result))
	{
		
		echo"<tr>";
			echo"<td>$rowval[fdate]</td>";
			echo"<td>$rowval[fdesc]</td>";
	...
	echo"<tr><td colspan='5'><center>Total</center></td><td>$total</td></tr>";

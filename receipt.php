...
$bdate=date("Y-m-d");
	...
	$sql = "select venue,description from  booking,billing,bookingdetail where billing.bookingid=bookingdetail.bookingid and billing.bookingid=booking.bookingid and billing.bookingid=$bookingid and billid=$billid";
...
<div class="d"><b><span style="margin-left: 1%;font-size:22px; width: 700%;"><?php echo "Bill Number:$billid";?></span></b><b><span style="margin-left: 550;font-size:22px; "><?php echo $bdate?></span></b></div>
	...
	echo"<a class='close' href='home.php' style='position: absolute; top: 690px; right: 130px; transition: all 200ms;

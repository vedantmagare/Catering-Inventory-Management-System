...
$bdate=date("Y-m-d");
	...
	$sql1 = "select venue,description from  booking,billing,bookingdetail where billing.bookingid=bookingdetail.bookingid and billing.bookingid=booking.bookingid and billing.bookingid=$bookingid and billid=$billid";
	$result = mysqli_query($con2,$sql1);
	$venue1="Nashik";
	echo $venue1;
	
	while($rowval1 = mysqli_fetch_array($result))
	{
		 $venue1= $rowval1['venue'];
		 $description1=$rowval1['description'];
 ...
 <div class="d"><b><span style="margin-left: 1%;font-size:22px; width: 700%;"><?php echo "Bill Number:$billid";?></span></b><b><span style="margin-left: 550;font-size:22px; "><?php echo $bdate?></span></b></div>  
	...
	<table width="700">
		...
		<tr><td><span  style="margin-left: -20%;font-size:22px;"><b>Venue:<?php echo$venue1;?></b></span></td> </tr>
		<tr><td><span  style="margin-left: -20%;font-size:22px;"><b>Description:<?php echo$description1;?></b></span></td> </tr>
	</table>
	<hr>
	...
	echo"<a class='close' href='mybooking.php' style='position: absolute; top: 690px; right: 130px; transition: all 200ms;
